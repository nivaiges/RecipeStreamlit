...
st.set_page_config(
    ...
    page_title='Recipes Around the World',
...
with col1:
    st.header('Recipe Explorer - _:blue[All Recipes in One Place]_', divider="rainbow")
    ...
    # st.markdown(colored_title('All Recipes in One Place', 'pink'), unsafe_allow_html=True)
    image_data = [
...
if search_option == 'Search by Name':
    ...
    # Recipe by Cuisine
    st.subheader("Select an option below to be shown a random recipe from this area:")
    ...
    if selected_cuisine:
        ...
        with col4:
            st.header(st.session_state.recipe_data['recipes'][0]['title'], divider="rainbow")
            st.text(" ")
        ...
        with col1:
            ...
            if selected_cuisine == "Indian":
                st.image('https://spoonacular.com/recipeImages/716364-556x370.jpg',
                         caption=st.session_state.recipe_data['recipes'][0]['title'], output_format='auto', use_column_width= "always")
            elif selected_cuisine == "Mexican":
                st.image('https://spoonacular.com/recipeImages/658644-556x370.jpg   ',
        ...
        with col2:
            ...
            st.markdown(st.session_state.recipe_data['recipes'][0]['summary'], unsafe_allow_html=True)
           # print(st.session_state.recipe_data['recipes'][0]['instructions'])
        with col3:
            st.subheader("Cooking Instructions", divider="rainbow")
            st.markdown(st.session_state.recipe_data['recipes'][0]['instructions'], unsafe_allow_html=True)
        if st.session_state.recipe_data:
            ...
            st.subheader("Recipe Completion Line Graph Percentage", divider = "rainbow")
        ...
        st.subheader(f'Map of {selected_cuisine} Region', divider="rainbow")
